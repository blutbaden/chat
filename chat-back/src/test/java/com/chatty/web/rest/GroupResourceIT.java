...
class GroupResourceIT {
    ...
    public static Group createEntity(EntityManager em) {
        Group group = new Group().name(DEFAULT_NAME).isActivated(DEFAULT_IS_ACTIVATED);
        return group;
    }
    ...
    public static Group createUpdatedEntity(EntityManager em) {
        Group group = new Group().name(UPDATED_NAME).isActivated(UPDATED_IS_ACTIVATED);
        return group;
    }
    ...
    void createGroup() throws Exception {
        ...
        assertThat(testGroup.getIsActivated()).isEqualTo(DEFAULT_IS_ACTIVATED);
    }
    ...
    void putNewGroup() throws Exception {
        ...
        updatedGroup.name(UPDATED_NAME).isActivated(UPDATED_IS_ACTIVATED);
        ...
        assertThat(testGroup.getIsActivated()).isEqualTo(UPDATED_IS_ACTIVATED);
    }
    ...
    void fullUpdateGroupWithPatch() throws Exception {
        ...
        partialUpdatedGroup.name(UPDATED_NAME).isActivated(UPDATED_IS_ACTIVATED);
